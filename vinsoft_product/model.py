...
class ProductTheme(models.Model): 
	...
	@api.multi
	def action_view_picking_receipts(self):
		# self.check = True
        ...
        'views': [(treeview_id,'tree'),(search_view_id,'search')],
        'search_view_id': search_view_id,
        'flags': {'action_buttons': True,'search_view':True},
    }
...
class ProductWizard(models.Model): 
	...
	products = fields.Many2many('product.template',string="Search Products")
